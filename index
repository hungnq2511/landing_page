...
If you register to be a user of Essential/Plus/Premium/Expert/Ultimate Accounts (a "Paid User"), our third party payment processor will also process information about your payment card and bank account information or payment account information that we require for the purpose of recording and processing your account registration. For further details, please refer to the point below titled "Payment information", under the section headed, "When we share your personal information."
...
We may use Google Analytics as a web analytics service on the Website, mobile apps and in conjunction with the widgets we provide. For more information on Google Analytics privacy practices, you can check here.
Analytics services for mobile and desktop applications that we may use:
Firebase — a development and analytics platform provided by Google. For more information on what type of information is collected, please visit the Firebase web page.
Flurry Analytics — provides us with tools and resources for understanding our mobile application users’ behavior. For more information on the handling of user data on Flurry Analytics, please see their Privacy Policy.
Visual Studio App Center — owned by Microsoft. Their applicable data protection provisions can be reviewed under the Microsoft Privacy Statement.
AppsFlyer — analytics services to measure and analyze the effectiveness of our marketing and advertising campaigns, as well as certain events and actions in the application. For more information on how AppsFlyer works and what data it collects, please see AppsFlyer Services Privacy Policy.
Sentry — is an error tracking and performance monitoring platform that helps us diagnose, fix, and optimize the performance of our platform. For more information on what data collected by Sentry, please see Sentry Privacy Policy.
...
For more information about how Google uses data, please refer to their Privacy & Terms document as well as Google’s Privacy Policy. You can opt out of this by visiting the Network Advertising Initiative opt-out page or by turning off the personalization of Google ads via their Ad Settings page.

Meta pixel — allows us to measure, optimise, and build audiences for our advertising campaigns.
You can learn more about Meta’s data policy here. You can manage your personal settings for advertisements on Facebook at Your Ad Preferences. In case you don’t have a Facebook account, you can use Your Online Choices website or DAA's WebChoices Tool to manage your ad experience.

Twitter Conversion Tracking (Twitter Pixel) — helps us to measure our return on ad expenditure.
For more information about Twitter data processing, please see their Privacy policy. You can adjust the settings in your personal Twitter profile and opt to receive advertising. In case you don’t have a Twitter account, you can use Your Online Choices website or DAA's WebChoices Tool to manage your ad experience.
...
YouTube API Services: We use the YouTube API to share your chosen video ideas to your YouTube account. When you use this service, you will need to sign in with your Google account and grant us permission to access your YouTube account. We will only use this access to upload videos that you choose to share with us. We will not store, modify, delete, or view any other data from your YouTube account. We will also not share your Google account information with any third parties. You can revoke our access to your YouTube account at any time by visiting Google security settings page. By using this service you are agreeing to be bound by the YouTube Terms of Service.
